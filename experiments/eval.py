...
def make_parser():
    ...
    parser.add_argument('--method', choices=['lgr', 'ransac', 'svd', 'ransac_featurematch'], default='svd', help='registration method')
...
def eval_one_epoch(args, cfg, logger):
    ...
    output_txt = osp.join(cfg.log_dir, 'eval-{}.txt'.format(time.strftime("%Y%m%d-%H%M%S")))
    outputs = []
    ...
    for i, file_name in pbar:
        try:
            ...
            # print([x for x in osp.splitext(osp.basename(file_name))[0].split('_')])
            seq_id, src_frame_pre, src_frame, ref_frame_pre, ref_frame = [x for x in osp.splitext(osp.basename(file_name))[0].split('_')]
        ...
        id0 = src_frame_pre+'_'+src_frame
        id1 = ref_frame_pre+'_'+ref_frame
        message = '{}/{}, seq_id: {}, id0: {}, id1: {}'.format(i + 1, num_test_pairs, seq_id, id0, id1)
        ...
        outputs.append("{} {} {} {} {} {} {} {} {} {} {} {}".format(id1, id0, est_quat[0], est_quat[1], est_quat[2], est_quat[3], est_translation[0], est_translation[1], est_translation[2], rre, rte, accepted))
