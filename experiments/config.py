...
_C.dataset = 'custom'    # kitti kitti360 apollo mulran
...
_C.data.custom_root = '/mnt_gx/usr/jiarun/data/training_data'
...
_C.backbone.init_voxel_size = 0.4
...
_C.fine_matching.acceptance_radius = 0.3
...
# loss - Fine level
_C.gap_loss = edict()
_C.gap_loss.positive_radius = 0.3
